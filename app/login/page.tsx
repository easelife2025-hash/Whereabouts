  ...
  return (
    <div className="flex flex-col h-full w-full bg-white relative">
      ...
      <div className="flex-1 overflow-y-auto px-6 pt-2 pb-safe flex flex-col">
        ...
        >
          <h1 className="text-[32px] font-bold text-zinc-900 tracking-tight mb-2">Welcome Back</h1>
          <p className="text-[15px] font-medium text-zinc-500 mb-8">Log in to manage your location sharing.</p>
          ...
          <form onSubmit={handleLogin} className="space-y-5">
            ...
            {message && (
              <motion.div 
                initial={{ opacity: 0, scale: 0.95 }}
                animate={{ opacity: 1, scale: 1 }}
                className="p-4 bg-green-50 text-green-700 text-[14px] font-semibold rounded-2xl border border-green-100 flex items-center gap-2"
              >
            ...
            <div>
              ...
              <div className="flex justify-end mt-3 px-1">
                <button 
                  ...
                  disabled={isLoading}
                  className="text-[13px] font-bold text-zinc-500 active:text-zinc-900 transition-colors disabled:opacity-50"
                >
                  Forgot password?
                </button>
              </div>
            ...
            <div className="pt-2">
              ...
              >
                {isLoading ? <Loader2 size={24} className="animate-spin text-zinc-900" /> : 'Log In'}
              </button>
            </div>
          </form>
          ...
          <div className="mt-8 text-center pb-8">
            <p className="text-[15px] font-medium text-zinc-500">
              ...
              <Link href="/signup" className="text-zinc-900 font-bold active:opacity-60 transition-opacity">
                Create one
              </Link>
            </p>
          </div>
